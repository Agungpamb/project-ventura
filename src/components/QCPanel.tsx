...
import { 
  ...
  Home, Sprout, Landmark, Save, X, Info, Loader2, Check, GitCompare
} from 'lucide-react';
...
interface QCPanelProps {
  ...
  onNavigateToSanding?: () => void;
  onNavigateToSandingEsdm?: () => void;
}

export default function QCPanel({ records, adminEmail, onSaveQC, onNavigateToSanding, onNavigateToSandingEsdm }: QCPanelProps) {
  ...
  return (
    <div className="space-y-6" id="sip_qc_panel">
        ...
        <div className="flex flex-wrap items-center gap-3 shrink-0">
          ...
          {onNavigateToSandingEsdm && (
            <button
              ...
              className="px-3.5 py-1.5 bg-emerald-600/90 hover:bg-emerald-500 text-white text-xs font-bold rounded-xl transition-all shadow-md shadow-emerald-600/20 flex items-center gap-1.5 cursor-pointer border border-emerald-400/30"
            >
      ...
      <div className="glass-card rounded-2xl shadow-xl overflow-hidden">
        ...
        {/* Scroll Control and Desktop Table View */}
          ...
          <div className="px-4 py-2 bg-slate-900/90 border-b border-white/10 flex flex-wrap items-center justify-between gap-3 text-xs">
            <div className="flex items-center gap-2 text-slate-400">
              ...
              <span className="text-[10px] text-slate-400 font-mono">
                Scroll mandiri vertikal &amp; horizontal (halaman tidak memanjang)
              </span>
            </div>
